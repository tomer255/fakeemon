...
public class FeedbackPanel extends JPanel {
    ...
    String htmlContent = "<html><p style=\"text-align:center\"><strong><span style=\"font-size:24px\"><span style=\"font-family:Comic Sans MS,cursive\">test</span></span></strong>\uD83D\uDE00</p></html>";

    private final JLabel feedbackLabel = new JLabel(htmlContent);
